...
function DoughnutChart({ data, label }) {
    ...
    const chartOptions = {
        plugins: {
            legend: {
                labels: { color: COLOURS.WHITE, font: { family: FONTS.SANS_SERIF, size: 14 } },
            },
...
function BarChart({ data, labels, align }) {
    ...
    const chartOptions = {
        ...
        plugins: {
            legend: {
                display: false,
                labels: { color: COLOURS.WHITE, font: { family: FONTS.SANS_SERIF, size: 13 } },
            },
        },
        scales: {
            y: {
                ticks: {
                    beginAtZero: true,
                    color: COLOURS.WHITE,
                    font: { family: FONTS.SANS_SERIF, size: 13 },
                },
            },
            x: {
                ticks: {
